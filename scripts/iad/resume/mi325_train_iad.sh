...
EXPERIMENT_NAME="Zoom-newprompt-mi325-resume-from80-rollout${N_ROLLOUT}-batch${BATCH_SIZE}-ppo${PPO_BATCH_SIZE}-micro${MICRO_BATCH_SIZE}"
RESUME_PATH=/wekafs/takisobe/zxy/models/verl_checkpoints/iad-tool/Zoom-newprompt-mi325-rollout8-batch32-ppo32-micro4/global_step_80
# ---------------- Train config -----------------
