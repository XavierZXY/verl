...
DATASET_TRAIN=/home/takisobe@amd.com/zxy/codes/verl-compare/data/data-v2/mvtec/train.parquet
...
EXPERIMENT_NAME="Zoom-data-1800-tw051--reward--batch${BATCH_SIZE}-ppo${PPO_BATCH_SIZE}-micro${MICRO_BATCH_SIZE}"
