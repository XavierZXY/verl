...
WORLD_SIZE=1
export SAVE_CHECKPOINT_DIR=/home/takisobe@amd.com/zxy/models/verl_checkpoints
# export VLLM_ATTENTION_BACKEND=XFORMERS # vllm + qwen2-7b with flash_attn has some issues

BASEDIR=/home/takisobe@amd.com/zxy/codes/verl
TRAIN_DATA=${BASEDIR}/mini_dataset.parquet
VALID_DATA=${BASEDIR}/mini_dataset.parquet
